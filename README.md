...
```sh
git clone https://github.com/TNO/tno-solar-nomad-plugin-base.git
cd tno-solar-nomad-plugin-base
...
tno-solar-nomad-plugin-base==x.y.z
```
...
```sh
pip install dist/tno-solar-nomad-plugin-base-0.1.0
```
